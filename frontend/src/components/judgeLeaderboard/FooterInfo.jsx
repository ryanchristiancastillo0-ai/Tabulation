...
function FooterInfo({ compType }) {
  return (
    <div className="p-4 sm:p-6 bg-white border border-[#BBCABB] rounded-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-3 sm:gap-4">
      <div>
        <span className="text-[9px] sm:text-[10px] font-bold text-[#9ca3af] uppercase tracking-widest block mb-1">
          Computation Rule
        </span>
        <span className="text-xs font-semibold text-[#4B5A4D]">
          {compType === 'rank'
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <span className="text-[10px] font-bold text-[#4B5A4D] uppercase tracking-widest">
          Synchronized
        </span>
      </div>
    </div>
