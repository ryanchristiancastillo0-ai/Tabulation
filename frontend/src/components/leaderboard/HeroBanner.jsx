export default function HeroBanner({ contestName, isRankMode }) {
  return (
    <div className="relative overflow-hidden px-4 sm:px-8 lg:px-12 py-7 sm:py-10">
      ...
      {/* Gold rule */}
      <div className="relative z-10 mb-3 w-14 h-[3px] bg-[#C9A227]" />
      ...
      <div className="relative z-10">
        ...
        <h1 className="text-xl sm:text-3xl font-bold text-white tracking-tight mb-1" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>
