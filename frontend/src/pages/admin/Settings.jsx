...
import { StrengthBar } from '../../pages/school';
import { USALoader } from '../../components/ui';
import { useTheme } from '../../context/ThemeContext';
import apiClient from '../../services/api';
import Button from '../../components/ui/Button';
import { isRequired, isStrongPassword, passwordsMatch } from '../../utils/validators';
import {
  ArrowLeft, KeyRound, Save, Check, AlertCircle, Pencil, X,
} from 'lucide-react';
...
export default function SettingsPage() {
  ...
  const handleChangePassword = async () => {
    if (!isRequired(curPassword) || !isRequired(newPassword) || !isRequired(confirmPassword)) {
