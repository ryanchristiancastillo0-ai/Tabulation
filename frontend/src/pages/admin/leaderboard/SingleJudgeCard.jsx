        ...
        <table className="w-full text-xs">
          <thead className="bg-[var(--accent)] text-white">
            <tr>
              ...
              <th className="px-2.5 sm:px-3 py-2 sm:py-2.5 text-right text-[9px] sm:text-[10px] uppercase tracking-wider font-semibold">Total</th>
            </tr>
          </thead>
          <tbody>
            {scores.length === 0 ? (
              ...
              <tr key={row.name} className="border-b border-[var(--border)] hover:bg-[var(--accent-lt)] transition-colors">
                ...
                <td className="px-2.5 sm:px-3 py-2 sm:py-2.5 font-bold text-[var(--text1)]">{row.name}</td>
                <td className="px-2.5 sm:px-3 py-2 sm:py-2.5 text-right font-mono font-bold text-[var(--accent-mid)]">
